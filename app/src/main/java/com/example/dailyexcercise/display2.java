    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (int_value){
            ...
            case 12:
                ...
                break;
            case 13:
                setContentView(R.layout.activity_barbell_high_pul);
                break;
            case 14:
                setContentView(R.layout.activity_dumbel_front_raise);
        }
    ...
    private void startTimer() {
        ...
        countDownTimer = new CountDownTimer(TimeLeft, 1000) {
            ...
            public void onFinish() {
                ...
                if (newvalue <= 7) {
                    Intent intent = new Intent(display2.this, display2.class);
